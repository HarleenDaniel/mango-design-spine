      ...
      <div className="px-6 md:px-12">
        ...
        >
          ...
          <button
            ...
            data-handle
          >
            <div className="h-9 w-9 rounded-full grid place-items-center bg-primary text-primary-foreground shadow-elev-2 transition-transform hover:scale-105 hover:shadow-elev-2">
